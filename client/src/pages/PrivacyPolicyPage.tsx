        ...
        >
          <DialogHeader className="text-center space-y-3 pb-2">
            ...
            <DialogDescription className="text-sm text-muted-foreground">
              يجب الموافقة على سياسة الخصوصية وشروط الاستخدام للاستمرار في استخدام نظام مُتْقِن
            </DialogDescription>
          </DialogHeader>

          <div className="space-y-4">
            <ScrollArea className="h-[350px] rounded-lg border p-4 text-sm leading-relaxed">
              <div className="space-y-4">
      ...
      <AlertDialog open={showRefuseConfirm} onOpenChange={setShowRefuseConfirm}>
        <AlertDialogContent dir="rtl">
          ...
          <AlertDialogFooter className="flex gap-2 sm:gap-2">
            <AlertDialogCancel data-testid="button-cancel-refuse">
              تراجع
            </AlertDialogCancel>
            <AlertDialogAction
