...
const sections = [
  {
    ...
    color: "text-primary",
    bg: "bg-primary/5",
    content: "مرحباً بكم في سِرَاجُ الْقُرْآنِ لإدارة حلقات القرآن الكريم. هذا النظام وقفي مجاني لوجه الله تعالى، مخصص لخدمة كتاب الله الكريم في الجوامع ومراكز التحفيظ. باستخدامك لهذا النظام فإنك تقرّ بقراءة هذه السياسة والموافقة عليها.",
  },
  {
    icon: Shield,
    ...
    content: "سِرَاجُ الْقُرْآنِ هو نظام وقفي لله تعالى، صُمِّم خصيصاً لخدمة كتاب الله الكريم من خلال تسهيل إدارة حلقات التحفيظ والمراجعة، ومتابعة تقدم الطلاب، وتنظيم العملية التعليمية بين الأساتذة والطلاب والمشرفين وأولياء الأمور.",
  },
  {
    icon: Eye,
