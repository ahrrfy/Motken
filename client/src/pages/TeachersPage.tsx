  ...
  return (
    <div className="p-4 md:p-6 space-y-4 md:space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold font-serif text-primary">الأساتذة</h1>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-right hidden sm:table-cell">عدد الطلاب</TableHead>
            ...
            <TableBody>
              {filteredTeachers.map((teacher) => (
                <TableRow key={teacher.id}>
                  ...
                  <TableCell dir="ltr" className="text-right hidden sm:table-cell">{teacher.phone}</TableCell>
                  <TableCell>
